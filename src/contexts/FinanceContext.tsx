...
// Dados mock iniciais - conforme Figma
const initialTransactions: Transaction[] = [
  ...
  },
  {
    ...
    type: 'expense',
    amount: 1500.00,
    description: 'Mercado Santo Antônio',
...
const initialCategories: Category[] = [
  ...
  { id: '4', name: 'Aluguel', type: 'expense', color: '#96CEB4', icon: '🏠' },
  { id: '5', name: 'Compras', type: 'expense', color: '#FFEAA7', icon: '🛒' },
  { id: '6', name: 'Lazer', type: 'expense', color: '#DDA15E', icon: '🎮' },
  { id: '7', name: 'Manutenção', type: 'expense', color: '#A0A0A0', icon: '🔧' },
  { id: '8', name: 'Roupas', type: 'expense', color: '#DDA15E', icon: '👕' },
  { id: '9', name: 'Salário', type: 'income', color: '#6C5CE7', icon: '💰' },
];
